		...
		<>
			...
			>
				...
				<Text fontSize="3xl" textAlign="center" mb={5}>
					...
					<br />
					Select the nearest hospital in the map below and click on directions to obtain the
					shortest way there.
				</Text>
				<Flex justifyContent="center" mb={30}>
					<iframe
						src="https://www.google.com/maps/d/u/0/embed?mid=1e9x7_sT9CPVAPgQnLP1KwBEKitpDnm4&ehbc=2E312F"
						width={'80%'}
						height={'600px'}
					></iframe>
				</Flex>
